 ...
 *  1) gcc -o OpenMP OpenMP.c -fopenmp
 *  2) ./OpenMP 10 4   <Argument 1 : Taille de la matrice, Argument 2 : seed aléatoire>.
 *
 */
...
int main(int argc, char **argv) {
    ...
    printf("\nTemps d'exécution avec openMP = %g ms.\n",(float)(endTime - startTime)/(float)1000);
...
void gaussOpenMP() {
    ...
    printf("Execution parallele avec openMP.\n");
